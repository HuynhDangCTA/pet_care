...
class NewRoomDogPage extends GetView<RoomController> {
  const NewRoomDogPage({super.key});

  @override
  Widget build(BuildContext context) {
    return Scaffold(
      appBar: AppBar(
        title: const Text('Thêm phòng cho cún'),
      ),
      body: Padding(
        ...
        child: Stack(
          children: [
            ...
            Obx(() => (controller.state.value is StateLoading)
                ? const Center(
                    child: LoadingWidget(),
                  )
                : Container())
